...
const translations = {
  zh: {
    ...
    'tools.compass.heading': '当前方位',
    'tools.compass.bearing': '方位角',
    'tools.compass.calibrate': '校准指南针',
    'tools.compass.calibrate.desc': '将设备进行8字形转动以校准磁力计',
    'tools.compass.accuracy': '精度',
    'tools.compass.coordinates': '当前坐标',
    'tools.compass.altitude': '海拔高度',
    'tools.emergency.contacts': '紧急联系人',
    'tools.emergency.add_contact': '添加联系人',
    'tools.emergency.call': '一键拨打',
    'tools.emergency.message': '发送位置',
    'tools.emergency.default.police': '当地警察',
    'tools.emergency.default.rescue': '山地救援',
    'tools.emergency.default.medical': '医疗急救',
    'tools.emergency.location.sharing': '位置共享',
    'tools.emergency.location.desc': '自动发送您的GPS坐标给紧急联系人',
  ...
  en: {
    ...
    'tools.compass.heading': 'Current Heading',
    'tools.compass.bearing': 'Bearing',
    'tools.compass.calibrate': 'Calibrate Compass',
    'tools.compass.calibrate.desc': 'Move device in a figure-8 motion to calibrate magnetometer',
    'tools.compass.accuracy': 'Accuracy',
    'tools.compass.coordinates': 'Current Coordinates',
    'tools.compass.altitude': 'Altitude',
    'tools.emergency.contacts': 'Emergency Contacts',
    'tools.emergency.add_contact': 'Add Contact',
    'tools.emergency.call': 'Quick Call',
    'tools.emergency.message': 'Send Location',
    'tools.emergency.default.police': 'Local Police',
    'tools.emergency.default.rescue': 'Mountain Rescue',
    'tools.emergency.default.medical': 'Medical Emergency',
    'tools.emergency.location.sharing': 'Location Sharing',
    'tools.emergency.location.desc': 'Automatically send your GPS coordinates to emergency contacts',
