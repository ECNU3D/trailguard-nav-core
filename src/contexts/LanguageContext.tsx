...
const translations = {
  zh: {
    ...
    // 环境监测工具
    'tools.environment.title': '环境监测',
    'tools.environment.desc': '利用Gemma 3n分析环境数据',
    'tools.environment.start_scan': '开始环境扫描',
    'tools.environment.scanning': '正在使用Gemma 3n分析环境...',
    'tools.environment.scan_complete': '环境分析完成',
    'tools.environment.data_updated': '环境数据已更新',
    'tools.environment.temperature': '温度',
    'tools.environment.wind_speed': '风速',
    'tools.environment.humidity': '湿度',
    'tools.environment.uv_index': 'UV指数',
    'tools.environment.sunlight': '今日日照',
    'tools.environment.sunrise': '日出',
    'tools.environment.sunset': '日落',
    'tools.environment.weather_forecast': '天气预测',
    'tools.environment.weather.sunny': '晴朗',
    'tools.environment.weather.cloudy': '阴云',
    'tools.environment.weather.partly_cloudy': '多云',
    'tools.environment.weather.rainy': '有雨',
    
    // 哨兵模式工具
    'tools.sentry.title': '哨兵模式',
    'tools.sentry.desc': '利用Gemma 3n监听环境声音',
    'tools.sentry.activate': '启动哨兵模式',
    'tools.sentry.deactivate': '停止哨兵模式',
    'tools.sentry.activated': '哨兵模式已开启',
    'tools.sentry.deactivated': '哨兵模式已关闭',
    'tools.sentry.monitoring': '正在使用Gemma 3n监听环境声音...',
    'tools.sentry.stopped': '停止监听',
    'tools.sentry.threat_level': '威胁等级',
    'tools.sentry.threat.high': '高',
    'tools.sentry.threat.medium': '中',
    'tools.sentry.threat.low': '低',
    'tools.sentry.current_volume': '当前音量',
    'tools.sentry.recent_detections': '最近检测',
    'tools.sentry.last_alert': '最后警报',
    'tools.sentry.high_sound_alert': '⚠️ 高声音警报',
    'tools.sentry.detected': '检测到',
    'tools.sentry.active': '激活中',
  ...
  en: {
    ...
    'tools.environment.title': 'Environment Scan',
    'tools.environment.desc': 'Analyze environment data with Gemma 3n',
    'tools.environment.start_scan': 'Start Environment Scan',
    'tools.environment.scanning': 'Analyzing environment with Gemma 3n...',
    'tools.environment.scan_complete': 'Environment Analysis Complete',
    'tools.environment.data_updated': 'Environment data updated',
    'tools.environment.temperature': 'Temperature',
    'tools.environment.wind_speed': 'Wind Speed',
    'tools.environment.humidity': 'Humidity',
    'tools.environment.uv_index': 'UV Index',
    'tools.environment.sunlight': 'Today\'s Sunlight',
    'tools.environment.sunrise': 'Sunrise',
    'tools.environment.sunset': 'Sunset',
    'tools.environment.weather_forecast': 'Weather Forecast',
    'tools.environment.weather.sunny': 'Sunny',
    'tools.environment.weather.cloudy': 'Cloudy',
    'tools.environment.weather.partly_cloudy': 'Partly Cloudy',
    'tools.environment.weather.rainy': 'Rainy',
    
    // Sentry mode tools
    'tools.sentry.title': 'Sentry Mode',
    'tools.sentry.desc': 'Monitor environment sounds with Gemma 3n',
    'tools.sentry.activate': 'Start Sentry Mode',
    'tools.sentry.deactivate': 'Stop Sentry Mode',
    'tools.sentry.activated': 'Sentry Mode Activated',
    'tools.sentry.deactivated': 'Sentry Mode Deactivated',
    'tools.sentry.monitoring': 'Monitoring environment sounds with Gemma 3n...',
    'tools.sentry.stopped': 'Stopped monitoring',
    'tools.sentry.threat_level': 'Threat Level',
    'tools.sentry.threat.high': 'High',
    'tools.sentry.threat.medium': 'Medium',
    'tools.sentry.threat.low': 'Low',
    'tools.sentry.current_volume': 'Current Volume',
    'tools.sentry.recent_detections': 'Recent Detections',
    'tools.sentry.last_alert': 'Last Alert',
    'tools.sentry.high_sound_alert': '⚠️ High Sound Alert',
    'tools.sentry.detected': 'Detected',
    'tools.sentry.active': 'Active',
